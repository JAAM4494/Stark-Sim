...
System.out.println("WARNING, Unknow character, line: " + yyline + ", column: " + yychar);
          ...
          case 61: break;
          case 9: 
            { echo(sym.J); return new Symbol(sym.J,           yyline, yychar, yytext());
            }
          case 62: break;
          case 10: 
          ...
          case 71: break;
          case 19: 
            { echo(sym.Lb); return new Symbol(sym.Lb,         yyline, yychar, yytext());
            }
          case 72: break;
          case 20: 
            { echo(sym.Lw); return new Symbol(sym.Lw,         yyline, yychar, yytext());
            }
          case 73: break;
          case 21: 
            { echo(sym.Sb); return new Symbol(sym.Sb,         yyline, yychar, yytext());
            }
          case 74: break;
          case 22: 
            { echo(sym.Sw); return new Symbol(sym.Sw,         yyline, yychar, yytext());
            }
          case 75: break;
          case 23: 
            { echo(sym.Or); return new Symbol(sym.Or,         yyline, yychar, yytext());
            }
          case 76: break;
          case 24: 
          ...
          case 77: break;
          case 25: 
            { echo(sym.R0); return new Symbol(sym.R0,         yyline, yychar, yytext());
            }
          case 78: break;
          case 26: 
            { echo(sym.R1); return new Symbol(sym.R1,         yyline, yychar, yytext());
            }
          case 79: break;
          case 27: 
            { echo(sym.R2); return new Symbol(sym.R2,         yyline, yychar, yytext());
            }
          case 80: break;
          case 28: 
          ...
          case 86: break;
          case 34: 
            { echo(sym.Je); return new Symbol(sym.Je,         yyline, yychar, yytext());
            }
          case 87: break;
          case 35: 
            { echo(sym.Xor); return new Symbol(sym.Xor,       yyline, yychar, yytext());
            }
          case 88: break;
          case 36: 
            { echo(sym.Lmw); return new Symbol(sym.Lmw,       yyline, yychar, yytext());
            }
          case 89: break;
          case 37: 
            { echo(sym.Smw); return new Symbol(sym.Smw,       yyline, yychar, yytext());
            }
          case 90: break;
          case 38: 
            { echo(sym.Shl); return new Symbol(sym.Shl,       yyline, yychar, yytext());
            }
          case 91: break;
          case 39: 
            { echo(sym.Shr); return new Symbol(sym.Shr,       yyline, yychar, yytext());
            }
          case 92: break;
          case 40: 
            { echo(sym.Mul); return new Symbol(sym.Mul,       yyline, yychar, yytext());
            }
          case 93: break;
          case 41: 
            { echo(sym.Min); return new Symbol(sym.Min,       yyline, yychar, yytext());
            }
          case 94: break;
          case 42: 
            { echo(sym.And); return new Symbol(sym.And,       yyline, yychar, yytext());
            }
          case 95: break;
          case 43: 
          ...
          case 101: break;
          case 49: 
            { echo(sym.Jlt); return new Symbol(sym.Jlt,       yyline, yychar, yytext());
            }
          case 102: break;
          case 50: 
            { echo(sym.Jne); return new Symbol(sym.Jne,       yyline, yychar, yytext());
            }
          case 103: break;
          case 51: 
            { echo(sym.Jgt); return new Symbol(sym.Jgt,       yyline, yychar, yytext());
            }
          case 104: break;
          case 52: 
            { echo(sym.Plus); return new Symbol(sym.Plus,     yyline, yychar, yytext());
            }
          case 105: break;
          case 53: 
            { echo(sym.Nand); return new Symbol(sym.Nand,     yyline, yychar, yytext());
            }
          case 106: break;
          default:
